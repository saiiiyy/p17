...
const transform17 = new Transform({
  position: new Vector3(15, 2, 6.362993240356445),
  rotation: new Quaternion(-1.1591285894172517e-14, 0.7191025018692017, -8.572369125658952e-8, -0.694904088973999),
  scale: new Vector3(4.883500099182129, 4.795694828033447, 1.000585913658142)
})
...
script4.spawn(imageFromURL, {"image":"https://webnexty.com/wp-content/uploads/2015/03/dummyimage.png"}, createChannel(channelId, imageFromURL, channelBus))
script2.spawn(nftPictureFrame9, {"id":"63460984615845189597705560094056282629448010796892788701527535441722323501057","contract":"0x495f947276749ce646f68ac8c248420045cb7b5e","style":"Blocky","color":"#000000","ui":true}, createChannel(channelId, nftPictureFrame9, channelBus))